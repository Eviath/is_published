...
Gem::Specification.new do |spec|
  spec.name          = "is_published"
  spec.version       = IsPublished::VERSION
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/Eviath/is_published.git"
    spec.metadata["changelog_uri"] = "https://github.com/Eviath/is_published.git"
  else
